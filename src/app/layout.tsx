...
export const metadata: Metadata = {
  ...
  description:
    "Full-stack developer building modern web apps, APIs, and digital systems. Engineering meets design meets futuristic UI.",
  keywords: [
    "Medin Turkes",
    "developer",
    "Next.js",
  ...
  return (
    <html lang="en" className="dark">
      ...
      <body className="antialiased">
        {/* CustomCursor removed — cursor is now handled purely via CSS in globals.css */}
